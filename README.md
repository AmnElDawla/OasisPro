...
| Team Members         | Tasks                 |
| -------------------- | --------------------- |
| Andre Nonaka Cordova | Readme.md<br>GUI Creation<br>Use Case Model<br>Traceability Matrix<br>Connection Test Feature <br> Intensity Feature |
...
| ---------------- | :-------------: | --------------------- | ------------- | ----------------- | --------------- | ---------- | ----- |
| Readme.md (will be continuously updated)       | 	 &#128994;     | Andre Nonaka Cordova  | Khaled Farag | 2022-11-25        | 2022-12-10      | N/A        | N/A   |
...
| Replay Therapy Feature (should have support for at least 4 users) |   &#128994;  | Alex Nedev and Mingrui Liang| N/A | 2022-11-30               | 2022-11-19      | N/A        | N/A   |
