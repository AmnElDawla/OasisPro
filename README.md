...
| Power Feature    |   &#128993;     | Khaled Farag          | N/A  | 2022-11-30 | N/A | 1 hours | Completed basic functionality.<br>Will add "Session Ended Early" use case when sessions are implemented.<br>Changed default colors to off and buttons to disabled, instead of being on at simulator launch. |
| Battery Level    |   &#128993;     | Khaled Farag          | N/A  | 2022-11-30 | N/A | 4 hours | Completed battery level display on launch.<br>Will add battery level display during session and low battery shutdown/lock when said features are implemented. |
